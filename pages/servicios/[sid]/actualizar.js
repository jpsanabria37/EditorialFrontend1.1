...
import { getCategoriaVehiculos, getTipoDocumentos } from "../../api/api";
...
const ActualizarServicioFormulario = ({ servicio, categoriaVehiculos }) => {
    ...
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/Servicio/${servicio.Id}`,
      {
        ...
        body: JSON.stringify({
          ...
          CategoriaVehiculoId: parseInt(selectedOption),
        }),
      }
    );
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              {errors.Descripcion && errors.Descripcion.length > 0 && (
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              {errors.Precio && errors.Precio.length > 0 && (
                <ErrorListProperty errors={errors.Precio} />
              )}
            </div>
          </div>
          <button
...
export default ActualizarServicioFormulario;
